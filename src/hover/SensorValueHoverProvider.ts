...
export class SensorValueHoverProvider implements vscode.HoverProvider {
	private readonly hoverObjects: { decoration: vscode.TextEditorDecorationType; 
		decorationRange: vscode.Range; sensorValues: SensorValues; }[]
	private formula : string | undefined
	constructor(hoverObjects: { decoration: vscode.TextEditorDecorationType; 
		decorationRange: vscode.Range; sensorValues: SensorValues; }[], formula: string | undefined) {
