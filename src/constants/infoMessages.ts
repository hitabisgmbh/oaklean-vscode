...
export const INFO_PROFILE_ASK_DELETED =
...
export const ERROR_FORMULA_NOT_VALID =
	'The formula is not valid and could not be saved.'
...
export const ERROR_EMPTY_NAME = 'A profile name cannot be empty.'
...
export const ERROR_FILE_IS_NOT_PART_OF_WORKSPACE =
	'File is not part of the workspace.'
export const ERROR_SOURCE_FILE_META_DATA_NOT_FOUND =
	'Could not find source file metadata for the document.'
